...
angular.
	...
	component('modifySurvey', {
		...
		controller: ['$location', '$routeParams', '$scope', '$http', "cookieService", 'awsService',
			function modifySurveyController($location, $routeParams, $scope, $http, cookieService, $awsService) {
